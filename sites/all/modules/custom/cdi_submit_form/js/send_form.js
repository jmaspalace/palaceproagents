      ...
      function validateCustomerInformation()
      {
        ...
        $('.box-cliente,#form-user').each(function(index, element)
        {
          ...
          $(element).find('input, select').each(function(index, element)
          {
            ...
            if ( $(element).attr('name') != '_of_children_in_room' && $(element).attr('name') != 'name' &&  $(element).attr('name') != 'arrival_date' &&  $(element).attr('name') != 'departure_date' &&  $(element).attr('name') != 'confirmation_'   ){
 /*var nombre = $(element).attr('name');
            alert(nombre);*/
            /*
              name
