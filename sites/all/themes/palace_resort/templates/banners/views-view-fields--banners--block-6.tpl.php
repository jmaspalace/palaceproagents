...
<?php
$tiene_video = (strip_tags($fields['field_url_video_banner']->content)!="") ? true : false;
$tiene_imagen = ($fields['field_image_banner']->content != "" || $fields['field_image_mobile_banner']->content != "") ? true : false;
?>

<?php if($tiene_imagen):?>
<?php if( ($tiene_video && cdi_custom_is_mobile() ) || !$tiene_video):?>
