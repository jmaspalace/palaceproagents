    ...
    <article class="block-black">
      ...
      if (cdi_custom_is_mobile()){ ?>
          <section class="col-md-6 col-sm-12 col-xs-12 image">
              <img src="<?= file_create_url($node->field_image_mobile_pe['und'][0]['uri']); ?>" alt="<?= $node->field_image_mobile_pe['und'][0]['alt'] ?>" title="<?= $node->field_image_mobile_pe['und'][0]['title'] ?>" class="img-responsive">
          </section>
      <?php } ?>
        <section class="col-md-6 col-sm-12 col-xs-12">
            <article class="content">
                <?= $node->field_description_pe['und'][0]['value'] ?>
                <div class="actions">
                    <a target="_blank" href="<?= file_create_url($node->field_pdf_file_pe['und'][0]['uri']) ?>" class="enlace enlace-orange"><?= $node->field_pdf_file_pe['und'][0]['description'] ?></a>
                </div>
            </article>
        </section>
      <?php
      ...
      ?>
          <section class="col-md-6 col-sm-6 col-xs-12 image">
              <img src="<?= file_create_url($node->field_image_desktop_pe['und'][0]['uri']); ?>" alt="<?= $node->field_image_desktop_pe['und'][0]['alt'] ?>" title="<?= $node->field_image_desktop_pe['und'][0]['title'] ?>" class="img-responsive">
          </section>
      <?php
      }
      ?>
...
<section class="block-terms container-fluid">
    ...
    <article class="content">
      <?= $node->field_terms_conditions_pe['und'][0]['value']; ?>
    </article>
</section>
