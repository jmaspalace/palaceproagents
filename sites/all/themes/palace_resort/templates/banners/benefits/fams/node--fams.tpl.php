...
<section class='block-content3 container-fluid'>
    <article class="container">
        <h2 class="line center">
            <span><?= $node->field_title_fams['und'][0]['value']; ?></span><br>
            <?= $node->field_subtitle_fams['und'][0]['value']; ?>
        </h2>
        <div class="text-center">
            <?= $node->field_intro_description_fams['und'][0]['value']; ?>
        </div>
    </article>
</section>
<section class="block-black-content2 gray container-fluid">
    <article class="image">
        <img src="<?= file_create_url($node->field_image_section_fams['und'][0]['uri']); ?>" title="<?= $node->field_image_section_fams['und'][0]['title']; ?>" alt="<?= $node->field_image_section_fams['und'][0]['alt']; ?>" class="img-responsive">
    </article>
    <article class="description">
        <section class="content">
            <h2 class="line">
                <span><?= $node->field_title_section_fams['und'][0]['value']; ?></span><br>
                <?= $node->field_subtitle_section_fams['und'][0]['value']; ?>
            </h2>
            <?= $node->field_description_section_fams['und'][0]['value']; ?>
        </section>
    </article>
</section>
